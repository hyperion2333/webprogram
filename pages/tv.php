...
<div class="page"><br>
  <img src="css/images/philips.png" class="img-responsive center-block"><br><br>
<!--PHILIPS---------------------->

<div class="a-cont" id="apple">
  
  <ul>
    <li><a href="#apple" class="clr"><div class="items"><div class="item-head"><img src="css/images/philips_img.png" class="img-responsive center-block"></div><div class="item-footer"><p>TV LED Smart Philips</p><div class="description"><p>599,99&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>


    <li><a href="#apple" class="clr"><div class="items"><div class="item-head"><img src="css/images/philips_img.png" class="img-responsive center-block"></div><div class="item-footer"><p>TV Philips 43PUS6401/12, SmartTv, 4K Ultra HD</p><div class="description"><p>799,69&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>

    <li><a href="#apple" class="clr"><div class="items"><div class="item-head"><img src="css/images/philips_img.png" class="img-responsive center-block"></div><div class="item-footer"><p>TV LED Smart Android Philips</p><div class="description"><p>990,49&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>
...
<!--PANASONIC---------------------->
<br><br><br><br>
  <img src="css/images/panasonic.png" class="img-responsive center-block"><br><br>
<div class="a-cont" id="asus">
  
  <ul>
    <li><a href="#asus" class="clr"><div class="items"><div class="item-head"><img src="css/images/panasonic_img.png" class="img-responsive center-block"></div><div class="item-footer"><p>TV OLED Smart Panasonic</p><div class="description"><p>1349,99&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>


    <li><a href="#asus" class="clr"><div class="items"><div class="item-head"><img src="css/images/panasonic_img.png" class="img-responsive center-block"></div><div class="item-footer"><p>TV OLED Smart Panasonic, 164 cm</p><div class="description"><p>3399,99&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>

    <li><a href="#asus" class="clr"><div class="items"><div class="item-head"><img src="css/images/panasonic_img.png" class="img-responsive center-block"></div><div class="item-footer"><p>TV OLED Smart Panasonic, 165 cm</p><div class="description"><p>4940,00&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>
...
<div class="a-cont" id="acer">
  ...
  <ul>
    ...
    <li><a href="#" class="clr"><div class="items"><span class="badge">35%</span><div class="item-head"><img src="css/images/samsung_img.png" class="img-responsive center-block"></div><div class="item-footer"><p>TV LED Smart Samsung</p><div class="description"><p><strike>3299,00&euro;</strike>2144,00&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>


    <li><a href="#" class="clr"><div class="items"><div class="item-head"><img src="css/images/samsung_img.png" class="img-responsive center-block"></div><div class="item-footer"><p>TV LED Smart Samsung, 138 cm</p><div class="description"><p>800,00&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>

    <li><a href="#" class="clr"><div class="items"><div class="item-head"><img src="css/images/samsung_img.png" class="img-responsive center-block"></div><div class="item-footer"><p>TV LED Smart 3D Samsung, 214 cm</p><div class="description"><p>5099,99&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>
  </ul>

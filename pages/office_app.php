...
<div class="page"><br>
<h3>Office Applications</h3><br><br><br><br>
<div class="a-cont" id="apple">
  
  <ul>
    <li><a href="#apple" class="clr"><div class="items"><div class="item-head"><img src="css/images/office_365.png" class="img-responsive center-block"></div><div class="item-footer"><p>Microsoft Office 365</p><div class="description"><p>259,99&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>

    <li><a href="#apple" class="clr"><div class="items"><div class="item-head"><img src="css/images/office2013.png" class="img-responsive center-block"></div><div class="item-footer"><p>Microsoft Office 2013</p><div class="description"><p>119,99&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>
    <li><a href="#apple" class="clr"><div class="items"><div class="item-head"><img src="css/images/office2010.png" class="img-responsive center-block"></div><div class="item-footer"><p>Microsoft Office 2010</p><div class="description"><p>99,99&euro;</p></div><button type="button" title="Buy Now" class="button btn-cart add-cart" onclick="setcheckoutLocation('<?php echo $this->getAddToCartUrl($_product) ?>'')"><div class="back-addc"><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></div><p><span class="glyphicon glyphicon-shopping-cart" style="color:white !important;"></span>add</p></button><a href="#" target="_blank"><div class="description-2"><p>&gt;&nbsp;See description</p></div></a></div></div></a></li>
